...
class CheckerSuite(unittest.TestCase):
    ...
    #     end
    #     """
    #     expect = "Type Mismatch In Statement: VarDecl(Id(b), ArrayType([1.0, 1.0], NumberType), None, ArrayLit(ArrayLit(NumLit(1.0), NumLit(2.0)), ArrayLit(NumLit(3.0)), ArrayLit(NumLit(4.0), NumLit(5.0))))"
    ...
    def test47(self):
        ...
        func t2()
            return 2
        """
        expect = "Type Mismatch In Statement: VarDecl(Id(b), None, dynamic, ArrayLit(ArrayLit(NumLit(0.0), NumLit(0.0))))"
